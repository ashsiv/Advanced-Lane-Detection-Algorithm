...
def fit_polynomial(leftx, lefty, rightx, righty, out_img):
    ...
    global left_fit, right_fit,sanity_check,flag
   ...
   #Sanity_check
    ...
    # if distance between lanes is not constant
    ...
    # if detected right & left lanes are very close are far than usual
    ...
    # Update the best case fits if no anamoly is detected
    else:
        sanity_check=True
        ...
        if(DEBUG ==0 and (leftlane.recent_xfitted != [] or leftlane.recent_fitted != [] or rightlane.recent_xfitted != [] or rightlane.recent_fitted != [])):
...
if(DEBUG):
    ...
    white_output = 'output_project_video_1.mp4'
